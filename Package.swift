...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/zhuixinjian/libghostty-spm/releases/download/ccp-fg-9a9002.1/GhosttyKit.xcframework.zip",
            checksum: "85aa43302c61ff5cd03f237774a1aef42eec644c471dc3f9273feb2277fe909d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
