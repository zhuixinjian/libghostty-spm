...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.1.3/GhosttyKit.xcframework.zip",
            checksum: "2de83f1085783456a9f5479583f49e5de8abad14f5c9ed52e5f54ab8c293d0a0"
        ),
        .testTarget(
            name: "GhosttyKitTest",
