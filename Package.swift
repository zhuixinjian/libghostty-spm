...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.2.10/GhosttyKit.xcframework.zip",
            checksum: "8727ec87042028d18ba8f6a0b2d03dd0a706201f4ba4a7c6dcdd391a4bb29fe0"
        ),
        .testTarget(
            name: "GhosttyKitTest",
